...
// the header file with the public function prototypes
//prefix filename with ../ and surround with ""
#define SERV_1_HEADER "../BluetoothService.h"
// the name of the Init function
#define SERV_1_INIT InitBluetoothService
// the name of the run function
#define SERV_1_RUN RunBluetoothService
// How big should this services Queue be?
...
// the header file with the public function prototypes
//prefix filename with ../ and surround with ""
#define SERV_2_HEADER "../RFIDService.h"
// the name of the Init function
#define SERV_2_INIT InitRFIDService
// the name of the run function
#define SERV_2_RUN RunRFIDService
// How big should this services Queue be?
...
// the header file with the public function prototypes
//prefix filename with ../ and surround with ""
#define SERV_3_HEADER "../LogicService.h"
// the name of the Init function
#define SERV_3_INIT InitLogicService
// the name of the run function
#define SERV_3_RUN RunLogicService
// How big should this services Queue be?
...
// the header file with the public function prototypes
//prefix filename with ../ and surround with ""
#define SERV_4_HEADER "../MotionSensorService.h"
// the name of the Init function
#define SERV_4_INIT InitMotionSensorService
// the name of the run function
#define SERV_4_RUN RunMotionSensorService
// How big should this services Queue be?
...
typedef enum {  ES_NO_EVENT = 0,
                ...
                ES_RFID_RESTART,
                ES_ACCEL_ACTION,
                ES_MOTION_SENSOR} ES_EventTyp_t ;
...
#define EVENT_CHECK_LIST Check4Keystroke,CheckforMotion
...
#define TIMER1_RESP_FUNC PostBluetoothService
#define TIMER2_RESP_FUNC PostLogicService//TIMER_UNUSED//PostAccelerometerService
#define TIMER3_RESP_FUNC PostMotionSensorService//TIMER_UNUSED//PostAccelerometerService
#define TIMER4_RESP_FUNC PostRFIDService
#define TIMER5_RESP_FUNC PostRFIDService
...
#define BLE_CHECKING_TIMER 1
//#define ACCELEROMETER_SENSOR_TIMER 2
//#define ACCELEROMETER_HOLD_TIMER 3
#define RESET_TIMER 2
#define MOTION_SENSOR_TIMER 3
#define  RFID_CHECKING_TIMER 4
#define  RFID_HOLD_TIMER 5
